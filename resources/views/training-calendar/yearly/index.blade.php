<x-app-layout>
    <div class="row mb-2">
        <div class="col-6">
            <a href="{{ route('training-calendar.monthly.index') }}" class="w-100 btn btn-secondary">
                Monthly Calendar
            </a>
        </div>
        <div class="col-6">
            <a href="{{ route('training-calendar.yearly.index') }}" class="w-100 btn btn-primary">
                Yearly Calendar
            </a>
        </div>
    </div>
    <div class="card">
        <div class="card-body p-0">
            <div class="px-3 py-2" style="border-bottom: 1px solid #dee2e6">
                <div class="row align-items-center">
                    <div class="col-12 text-end">
                        ...
                        @endif
                        <a href="{{route('training-calendar.yearly.list')}}" class="btn btn-sm btn-primary">
            ...
            <div class="p-3">
                ...
                @else
                    <p class="my-0">No training calendar PDF available.</p>
                @endif
            </div>
        </div>
    </div>
