        ...
        <div class="card-body p-0">
            <div class="p-3" style="border-bottom: 1px solid #dee2e6">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="mb-0">Monthly Calendar List</h5>
                    </div>
    ...
    @push('scripts')
        ...
        <script>
            $(document).on('click', '.add-btn', function () {
                ...
                $.ajax({
                    url: "/training-calendar/monthly/create",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        toastr.success('Monthly Calendar added successfully!', '', { timeOut: 8000 });
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                $.ajax({
                    url: "/training-calendar/monthly/" + calendarId + "/edit",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        console.log(response);
                        toastr.success('Monthly Calendar updated successfully!', '', { timeOut: 8000 });
                        $('#dataTableBuilder').DataTable().ajax.reload();
                    },
                    error: function (xhr) {
                        console.log(xhr.responseText);
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                $.ajax({
                    url: "/training-calendar/monthly/" + calendarId + "/delete",
                    type: "DELETE",
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}"
                    },
                    success: function (response) {
                        ...
                        console.log(response);
                        toastr.success('Monthly Calendar removed successfully!', '', { timeOut: 8000 });
                        $('#dataTableBuilder').DataTable().ajax.reload();
                    },
                    error: function (xhr) {
                        console.log(xhr.responseText);
